...
<p align="left">
  <a href="https://profile.codersrank.io/user/nipunaranasinghe" target="_blank">
    <img img height="237px" src="[https://cr-ss-service.azurewebsites.net/api/ScreenShot?widget=summary&username=nipunaranasinghe](https://cr-ss-service.azurewebsites.net/api/ScreenShot?widget=summary&username=nipunaranasinghe&badges=3&show-avatar=false&style=--header-bg-color:%23000;--border-radius:10px)"/>
  </a>
</p>
